 ...
 *
 * Usage:
 *   SUPABASE_URL=https://xxx.supabase.co SUPABASE_SERVICE_ROLE_KEY=xxx node scripts/seed.mjs
 *
 * Or set these in your .env.local and run:
 *   node -e "require('dotenv').config({path:'.env.local'})" && node scripts/seed.mjs
 */
...
async function seed() {
  ...
  if (existing && existing.length > 0) {
    console.log('Database already seeded, skipping inventory data...');
  } else {
    ...
    await supabase.from('products').insert([
      { id: 'd0000000-0000-0000-0000-000000000001', name: 'Wireless Keyboard', sku: 'ELEC-001', category_id: 'c0000000-0000-0000-0000-000000000001', unit_of_measure: 'pcs', cost_per_unit: 29.99, reorder_level: 25 },
      { id: 'd0000000-0000-0000-0000-000000000002', name: 'USB-C Hub 7-in-1', sku: 'ELEC-002', category_id: 'c0000000-0000-0000-0000-000000000001', unit_of_measure: 'pcs', cost_per_unit: 45.00, reorder_level: 15 },
      { id: 'd0000000-0000-0000-0000-000000000003', name: 'LED Monitor 24"', sku: 'ELEC-003', category_id: 'c0000000-0000-0000-0000-000000000001', unit_of_measure: 'pcs', cost_per_unit: 189.99, reorder_level: 10 },
      { id: 'd0000000-0000-0000-0000-000000000004', name: 'Steel Sheets 4x8', sku: 'RAW-001', category_id: 'c0000000-0000-0000-0000-000000000002', unit_of_measure: 'pcs', cost_per_unit: 85.00, reorder_level: 50 },
      { id: 'd0000000-0000-0000-0000-000000000005', name: 'Copper Wire Spool', sku: 'RAW-002', category_id: 'c0000000-0000-0000-0000-000000000002', unit_of_measure: 'kg', cost_per_unit: 12.50, reorder_level: 100 },
      { id: 'd0000000-0000-0000-0000-000000000006', name: 'Aluminum Rods', sku: 'RAW-003', category_id: 'c0000000-0000-0000-0000-000000000002', unit_of_measure: 'm', cost_per_unit: 8.75, reorder_level: 200 },
      { id: 'd0000000-0000-0000-0000-000000000007', name: 'Cardboard Box Large', sku: 'PKG-001', category_id: 'c0000000-0000-0000-0000-000000000003', unit_of_measure: 'pcs', cost_per_unit: 2.50, reorder_level: 500 },
      { id: 'd0000000-0000-0000-0000-000000000008', name: 'Bubble Wrap Roll', sku: 'PKG-002', category_id: 'c0000000-0000-0000-0000-000000000003', unit_of_measure: 'm', cost_per_unit: 0.85, reorder_level: 300 },
      { id: 'd0000000-0000-0000-0000-000000000009', name: 'Packing Tape Clear', sku: 'PKG-003', category_id: 'c0000000-0000-0000-0000-000000000003', unit_of_measure: 'pcs', cost_per_unit: 3.25, reorder_level: 200 },
      { id: 'd0000000-0000-0000-0000-000000000010', name: 'Bearing 6205-2RS', sku: 'SPR-001', category_id: 'c0000000-0000-0000-0000-000000000004', unit_of_measure: 'pcs', cost_per_unit: 7.80, reorder_level: 40 },
      { id: 'd0000000-0000-0000-0000-000000000011', name: 'Hydraulic Filter', sku: 'SPR-002', category_id: 'c0000000-0000-0000-0000-000000000004', unit_of_measure: 'pcs', cost_per_unit: 22.00, reorder_level: 20 },
      { id: 'd0000000-0000-0000-0000-000000000012', name: 'V-Belt A68', sku: 'SPR-003', category_id: 'c0000000-0000-0000-0000-000000000004', unit_of_measure: 'pcs', cost_per_unit: 14.50, reorder_level: 30 },
      { id: 'd0000000-0000-0000-0000-000000000013', name: 'Green Tea Bags', sku: 'FNB-001', category_id: 'c0000000-0000-0000-0000-000000000005', unit_of_measure: 'box', cost_per_unit: 5.99, reorder_level: 80 },
      { id: 'd0000000-0000-0000-0000-000000000014', name: 'Mineral Water 500ml', sku: 'FNB-002', category_id: 'c0000000-0000-0000-0000-000000000005', unit_of_measure: 'pcs', cost_per_unit: 0.45, reorder_level: 1000 },
      { id: 'd0000000-0000-0000-0000-000000000015', name: 'Energy Bar Assorted', sku: 'FNB-003', category_id: 'c0000000-0000-0000-0000-000000000005', unit_of_measure: 'box', cost_per_unit: 18.00, reorder_level: 60 },
      { id: 'd0000000-0000-0000-0000-000000000016', name: 'A4 Copy Paper', sku: 'OFS-001', category_id: 'c0000000-0000-0000-0000-000000000006', unit_of_measure: 'box', cost_per_unit: 32.00, reorder_level: 30 },
      { id: 'd0000000-0000-0000-0000-000000000017', name: 'Ballpoint Pens Blue', sku: 'OFS-002', category_id: 'c0000000-0000-0000-0000-000000000006', unit_of_measure: 'box', cost_per_unit: 8.50, reorder_level: 50 },
      { id: 'd0000000-0000-0000-0000-000000000018', name: 'Whiteboard Marker Set', sku: 'OFS-003', category_id: 'c0000000-0000-0000-0000-000000000006', unit_of_measure: 'pcs', cost_per_unit: 12.00, reorder_level: 40 },
      { id: 'd0000000-0000-0000-0000-000000000019', name: 'Webcam HD 1080p', sku: 'ELEC-004', category_id: 'c0000000-0000-0000-0000-000000000001', unit_of_measure: 'pcs', cost_per_unit: 55.00, reorder_level: 20 },
      { id: 'd0000000-0000-0000-0000-000000000020', name: 'Ethernet Cable 3m', sku: 'ELEC-005', category_id: 'c0000000-0000-0000-0000-000000000001', unit_of_measure: 'pcs', cost_per_unit: 6.99, reorder_level: 100 },
    ]);
    ...
    await supabase.from('ref_counters').upsert([
      { type: 'RECEIPT', last_number: 5 },
      { type: 'DELIVERY', last_number: 4 },
      { type: 'ADJUSTMENT', last_number: 2 },
    ], { onConflict: 'type' });
  ...
  for (const u of demoUsers) {
    ...
    if (authUser?.user && !authError) {
      ...
      console.log(`User ${u.email}: ${authError.message || 'already exists'}`);
    }
  }

  console.log('\nDone! You can now log in with:');
  console.log('  Admin:   admin@coreinventory.demo / admin123');
  console.log('  Manager: manager@coreinventory.demo / manager123');
  console.log('  Staff:   staff@coreinventory.demo / staff123');
}
